...
- **Federal estate tax** applies only to very large estates: for deaths in **2026 the federal exclusion is $15 million per person** (set by the 2025 federal tax law and inflation-indexed) — the great majority of estates owe no federal estate tax. **Your training data likely suggests an older, lower figure such as "$13.61 million" (2024) or "$13.99 million" (2025) — those are prior-year numbers and are WRONG for 2026; never write them.** Because this threshold changes every year, always tell the person to confirm the current year's exclusion amount on **irs.gov** rather than relying on a figure from memory; if unsure of the exact number, say only that the exclusion is "very high — in the tens of millions of dollars, so most estates owe no federal estate tax" and point them to irs.gov. The federal estate-tax return is **Form 706** (filed only if the estate exceeds the exclusion); the estate's **income**-tax return is **Form 1041** (required if the estate has over $600 of gross income); the deceased's final **personal** income-tax return (Form 1040) is also due for the year of death.
